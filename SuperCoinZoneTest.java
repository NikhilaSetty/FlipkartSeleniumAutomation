...
public class SuperCoinZoneTest extends BaseClass{
	...
	public void superCoinZoneTest()
	{
		...
		WebElement subMenu = driver.findElement(CommonPage.SuperCoinZone);
		...
		WebElement viewCoinActivity = driver.findElement(CommonPage.ViewCoinActivity);
